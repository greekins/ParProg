...
class Philosopher extends Thread {
	...
	private void takeForks() throws InterruptedException {
		...
		/*
		 * Lösungsansatz 1 (kompakt):
		 */
//		int leftForkNo = Math.min(table.leftForkNumber(id), table.rightForkNumber(id));
//		int rightForkNo = Math.max(table.leftForkNumber(id), table.rightForkNumber(id));
		
		/*
		 * Lösungsansatz 2 (extended version):
		 */
